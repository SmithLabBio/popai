...
for key in sample_sizes:
    ...
    count+=1
my_test_demography.set_symmetric_migration_rate(populations=["A","C"], rate=5e-5)
my_test_demography.add_symmetric_migration_rate_change(populations=["A","C"], rate=0, time=tdiv1//2)
