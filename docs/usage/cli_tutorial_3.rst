...
.. code-block:: python
    ...
    train_models --config tutorial_3_data/config.txt --simulations simulated/ --output trained_models --downsampling "{'A':20, 'B':20, 'C':20}" --rf --fcnn --cnn --cnnnpy
...
.. code-block:: python
    ...
    apply_models --config tutorial_3_data/config.txt --models trained_models/  --output results/ --empirical empirical/ --downsampling "{'A':20, 'B':20, 'C':20}" --rf --fcnn --cnn --cnnnpy --simulations simulated/
