...
def main():
    ...
    if args.cnn:
        model = models.load_model(os.path.join(args.models, "cnn.keras"), compile=True)  
        features = models.load_model(os.path.join(args.models, "cnn_featureextractor.keras"), compile=True)
