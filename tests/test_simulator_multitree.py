...
popfile = ./tests/populations.txt
    ...
    def test_build_models(self):
        ...
        self.assertEqual(arrays[12][0].shape, (18, max_sites))
        self.assertEqual(sfs_2d[12][0][('A','B')].shape, (9,5))
        self.assertEqual(sfs_2d[12][0][('A','C')].shape, (9,7))
        self.assertEqual(sfs_2d[12][0][('C','B')].shape, (7,5))
        self.assertEqual(msfs[12][0].shape, (9*5*7,))
        self.assertEqual(binned_msfs[12][0].shape, (4*4*4,))
